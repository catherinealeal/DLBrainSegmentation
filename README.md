# Deep Learning Models for Automatic Brain Segmentation
...
## View full internship report notebook [here](https://github.com/catherinealeal/DLBrainSegmentation/blob/main/FullReport.ipynb).
